...
module.exports = {
  slideConfig: { type: "cover", index: 1, title: "WorkBuddy 产品与基础入门" },
  createSlide(pres) {
    ...
    s.addText("产品定位 · 四大核心能力 · 安装配置 · 主界面 · 三种工作模式", {
    ...
    for (let i = 0; i < 9; i++) {
      s.addShape("ellipse", {
        ...
        fill: { color: i < 1 ? "28B894" : "FFFFFF", transparency: i < 1 ? 20 : 75 }
      });
    }
    s.addText("WorkBuddy 效率进阶实训课程 · 配套实验（实验 1.1-1.4）", {
