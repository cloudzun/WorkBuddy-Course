// slide-18.js — 一句话口诀（大结论页）
const { C, sectionTitle, bigCallout } = require("./common");
module.exports = {
  slideConfig: { type: "callout", index: 18, title: "一句话口诀" },
  createSlide(pres) {
    ...
    const lines = [
      ...
      { k: "想要成品", v: "找灵感", c: "B8E8DC" },
    ];
    lines.forEach((it, i) => {
      const y = 1.8 + i * 1.0;
      s.addText(it.k, { x: 1.0, y, w: 3.2, h: 0.7, fontSize: 22, fontFace: "Microsoft YaHei", color: it.c, valign: "middle", margin: 0 });
      ...
      s.addText(it.v, { x: 4.9, y: y + 0.08, w: 3.4, h: 0.55, fontSize: 22, fontFace: "Microsoft YaHei", bold: true, color: C.textLight, align: "center", valign: "middle", margin: 0 });
    });
    s.addText("—— 灵感 = 技能 + 专家的“成品化封装”，三者共同构成 WorkBuddy 的能力体系", {
