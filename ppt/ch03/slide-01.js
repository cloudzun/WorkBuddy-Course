...
module.exports = {
  slideConfig: { type: "cover", index: 1, title: "灵感模块" },
  createSlide(pres) {
    ...
    for (let i = 0; i < 9; i++) {
      s.addShape("ellipse", {
        ...
        fill: { color: i < 3 ? "28B894" : "FFFFFF", transparency: i < 3 ? 20 : 75 }
      });
    }
    s.addText("WorkBuddy 效率进阶实训课程 · 配套实验（实验 3.1-3.3）", {
