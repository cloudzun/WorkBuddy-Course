...
module.exports = {
  slideConfig: { type: "cover", index: 1, title: "自动化" },
  createSlide(pres) {
    ...
    for (let i = 0; i < 9; i++) {
      s.addShape("ellipse", {
        ...
        fill: { color: i < 8 ? "28B894" : "FFFFFF", transparency: i < 8 ? 20 : 75 }
      });
    }
    s.addText("WorkBuddy 效率进阶实训课程 · 配套实验（实验 8.1-8.4）", {
