...
module.exports = {
  slideConfig: { type: "cover", index: 1, title: "典型办公场景综合实战与 OPC 一人公司" },
  createSlide(pres) {
    ...
    s.addText("典型办公场景综合实战\n与 OPC 一人公司", {
      x: 1.2, y: 1.5, w: 8.2, h: 1.6,
      fontSize: 42, fontFace: "Microsoft YaHei", bold: true, color: C.textLight, margin: 0, lineSpacingMultiple: 1.05
    });
    s.addShape("rect", { x: 1.25, y: 3.18, w: 2.2, h: 0.045, fill: { color: "28B894" } });
    s.addText("四条办公链路实战串联 · 进阶能力 · OPC 一人公司商业闭环", {
      x: 1.2, y: 3.4, w: 8.2, h: 0.6,
    ...
    for (let i = 0; i < 9; i++) {
      s.addShape("ellipse", {
        ...
        fill: { color: i < 9 ? "28B894" : "FFFFFF", transparency: i < 9 ? 20 : 75 }
      });
    }
    s.addText("WorkBuddy 效率进阶实训课程 · 配套实验：综合演练（咖啡品牌季度经营分析）", {
